...
function generateTabung2(r, xUp, yUp, zOrigin, zUp, c1,c2,c3, vertex,faces, factorX, factorY){
    ...
    var object = new MyObject(vertex,faces,shader_vertex_source,shader_fragment_source);
    return object;
};
